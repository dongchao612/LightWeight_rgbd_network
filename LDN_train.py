...
from model.LDN_net import LDNNet
import argparse
import os
import time
import warnings
...
from model.net_part import LDN_CrossEntropyLoss2d
...
def train():
    ...
    for epoch in range(int(args.start_epoch), args.epochs):
        ...
        if epoch % args.save_epoch_freq == 0 and epoch != args.start_epoch:
            save_ckpt(args.ckpt_dir, model, optimizer, global_step)
